...
class publicacionesSeeder extends Seeder
{
    ...
    public function run()
    {
        $temasu1 = [ 'Unidad 1 Componentes y características del Cliente/Servidor','Componentes del modelo Cliente/Servidor.','concepto de programa maestro','Procesos y tareas del programa maestro.',
        'Tipos de servidores','Reconocer las características de la arquitectura Cliente/Servidor: servicios, recursos compartidos, protocolos asimétricos, independencia de la ubicación, compatibilidad de clientes y servidores, comunicación de mensajes, encapsulación de servicios, escalabilidad e integridad.',
    ...
    $contenidoedit = [
        ...
        Servicios: Un servicio es un conjunto de información que busca responder las necesidades de un cliente, donde esta información pueden ser mail, música, mensajes 
        simples entre software, videos, etc.
        Base de datos: Son bancos de información ordenada, categorizada y clasificada que forman parte de la red, que son sitios de almacenaje para la utilización de los servidores y 
      ...
      <p>El Programa Maestro de Producción, conocido como Programa maestro o MPS -en inglés Master production Schedule- es un programa que muestra qué productos 
        ...
        Se trata de un programa generado a partir de la desagregación de la planificación de la producción agregada, que se encargará de guiar las acciones de 
          producción a lo largo de aproximadamente 6 a 12 meses normalmente sobre una base semanal, teniendo en cuenta los pedidos existentes.
        El plan maestro de producción es un programa que contiene todo lo que se va a producir y cuándo se va a producir.
        se definen las fechas de entrega de cada producto y se analiza cuántas unidades se pueden fabricar en un intervalo de tiempo determinado.
...
El objetivo de la planificación de materiales es conocer la cantidad y el plazo del pedido para realizar la compra de materiales y así obtener una buena gestión.</p>",
      ...
      Existen tecnologías, suficientemente desarrolladas, diseñadas para el paradigma de C/S que aseguran la seguridad en las transacciones, la amigabilidad del interfaz, y la facilidad de empleo.</p>
      <h2>DESVENTAJAS</h2>
      ...
      <p>Antes de la llegada de la computación en la nube, las organizaciones compraban y mantenían una infraestructura local de TI. Aunque el ahorro de costes impulsó gran parte del cambio inicial a la nube, muchas organizaciones opinan que las infraestructuras de nube pública, privada o híbrida ofrecen numerosas ventajas.</p>
      <h3>FUNDAMENTOS</h3>
      <p>Cuando una empresa decide migrar a la nube, significa que traslada su infraestructura de TI fuera del entorno local, a un centro de datos mantenido por un proveedor de Cloud Computing (como Oracle). Un proveedor de nube líder de la industria tiene la responsabilidad de gestionar la infraestructura de TI del cliente, integrar las aplicaciones y desarrollar nuevas capacidades y funcionalidades para seguir el ritmo de las demandas del mercado.</p>
      <h3>TIPOS DE COMPUTOS DE NUBES</h3>
      <p>NUBE PRIVADA</p>
      <p>La nube privada es de uso exclusivo de una organización. Se puede alojar en la ubicación de la organización o en el centro de datos del proveedor de la nube. La nube privada proporciona un nivel más alto de seguridad y control.</p>
      <p>NUBE HIBRIDA</p>
      <p>Como su nombre indica, una nube híbrida es una combinación de nubes públicas y privadas. En general, el cliente aloja sus aplicaciones críticas en sus propios servidores para mayor seguridad y control, y las aplicaciones secundarias se almacenan en el entorno de un proveedor de nube.</p>
      <p>MULTINUBE</p>
      <p>La principal diferencia entre nube híbrida y multinube es el uso de varios dispositivos de Cloud Computing y almacenamiento en una sola arquitectura. Hay que centrarse en añadir algunas palabras clave en el cuerpo.</p>",
...
<p>IaaS ofrece también servicios de virtualización como máquinas virtuales, cortafuegos, sistemas de backups o balanceadores de carga.</p>

<p>IaaS es la base del servicio y contiene los bloques fundamentales para la TI en la nube, pues proporciona los servicios y estructuras necesarios sobre los cuales se construyen los otros servicios.</p>

<h2>Ejemplos de IaaS</h2>
<p>Amazon Web Services y Microsoft Azure son dos claros ejemplos de infraestructura como servicios, a continuación vemos las principales características de cada uno.</p>
...
Amazon Web Services: el proveedor de servicios en la nube de Amazon es un claro ejemplo de IaaS. Con su servicio central Amazon EC2, permite a los usuarios alquilar servidores virtuales en los cuales instalar sus aplicaciones. EC2 ofrece configuraciones de hardware que pueden ser contratadas por los clientes.
 En estas configuraciones, llamadas tipos de instancias, se puede elegir entre una variedad de CPUs, memoria RAM, almacenamiento en disco duro y capacidad de transferencia de red. Además ofrece otros servicios anexos, como contratación de cortafuegos, direcciones IPv4 estáticas y redes virtuales independientes.
Microsoft Azure: Microsoft también dispone de un servicio IaaS con Azure. En él, se puede realizar una contratación de hardware personalizada en cuanto a CPU, memoria, almacenamiento y velocidad de red. En esta infraestructura los clientes pueden hacer correr sus aplicaciones empresariales, como por ejemplo SAP o Sharepoint sin necesidad de preocuparse por el hardware necesario para hacerlo.
 Microsoft Azure destaca por la gran cantidad de recursos que pueden ser contratados, lo que la hace ideal para las empresas con necesidades muy exigentes en cuanto a infraestructura.</p>
<h2>Qué es PaaS</h2>
<p>El servicio PaaS ofrece plataformas como servicios. En estas plataformas se pueden lanzar aplicaciones como bases de datos, middleware, herramientas de desarrollo, servicios de inteligencia empresarial, etc.</p>

<p>Este tipo de servicios es el ideal para los desarrolladores que sólo quieran centrarse en la implementación y administración de sus aplicaciones. Al no tener que preocuparse por los recursos de hardware y software (sistemas operativo), mejoran su eficacia, centrándose sólo en la parte que les interesa.</p>

<p>PaaS es la más complicada de entender debido a que el término plataforma puede confundirse con software. Una plataforma es un software de por sí, que permite desarrollar aplicaciones.</p>

<h2>Ejemplos de PaaS</h2>
<p>Google App Engine y Bungee Connect son dos ejemplos de plataformas como servicios y tienen las siguientes características.</p>

<p>Google App Engine: este servicio de Google está enfocado a que el cliente pueda publicar aplicaciones web online, sin tener que preocuparse por la infraestructura donde hacerlo. Así, el cliente se enfoca solamente en la construcción y configuración de sus aplicaciones, siendo Google la encargada de aprovisionar de los recursos necesarios. Google App Engine cuenta con un nivelador de carga, que va aumentando los recursos necesarios según necesiten las aplicaciones, por lo que no es necesario preocuparse por la escalabilidad.</p>
<p>Bungee Connect: es uno de los primeros servicios PaaS que permitieron el despliegue de aplicaciones en la nube sin preocuparse por la infraestructura. Con el servicio de Bungee Connect se obtiene un entorno adecuado para el desarrollo, testeo y ejecución de aplicaciones web.</p>
<h2>Qué es SaaS</h2>
<p>Este modelo de software como infraestructura, aloja el software de la empresa, así como sus datos, en servidores externos a la misma, y paga una cuota por su utilización. Cualquier empleado de una empresa podrá acceder desde cualquier lugara las aplicaciones de la empresa sin necesidad de instalarlas en un equipo local. Cuando hablamos de software en la nube estamos hablando de SaaS.</p>

<p>Con un SaaS la preocupación de la empresa será sólo cómo utilizar los programas de software necesarios para su funcionamiento, olvidándose del resto de recursos. El hardware requerido, sistemas operativos, aplicaciones, etc. son provistas por el proveedor del servicio que, además, se encarga de mantenerlas funcionando correctamente y actualizadas.</p>

<p>Todos los usuarios acceden diariamente a aplicaciones SaaS ya que se puede decir que, cualquier aplicación online que se ejecuta en la nube y que se pueda acceder a ella a través de internet, es una aplicación SaaS.</p>",
    ];
...
'Definir los conceptos de lógica de acceso, presentación y negocio a datos.','Explicar el proceso de diseño de logica de acceso a datos, lógica de presentación de datos y lógica de negocio o lógica de aplicación.',
'Explicar el proceso de desarrollo de logica de acceso a datos, lógica de presentación de datos y lógica de negocio o lógica de aplicación.'
, 'Definir el concepto de nivel vinculado a programación web.','Explicar el proceso de planificación en dos niveles.','Explicar el proceso de planificación en tres niveles','Explicar el proceso de planificación multiniveles.','Identificar problemas de actualización y mantenimiento de aplicaciones multinivel.',
'Reconocer los conceptos de modelo, control y vista, en las arquitecturas Cliente/Servidor.', 'Reconocer el concepto del Modelo Vista Controlador (MVC) en las arquitecturas Cliente/Servidor',
'Explicar el proceso de flujo de control a partir del MVC, en las arquitecturas Cliente/Servidor.','Describir el desarrollo de software a partir del MVC, en las arquitecturas Cliente/Servidor.',
'Definir el concepto de comunicación orientada a conexión e interfaz de programación de aplicaciones (API).','Explicar el proceso de comunicación y configuración orientada a conexión e interfaz de programación de aplicaciones (API).',
'Definir el concepto de sockets.','Explicar el proceso del uso de sockets en aplicaciones Cliente/Servidor.'];
    ...
    $tituloeditu2 = [
        ...
        <ul><li>Unidad 2</li></ul>",
        //Quinto titulo del tema
        "<h1'>Unidad 2: Definir el concepto de nivel vinculado a programación web.</h1>
        <ul><li>Unidad 2</li></ul>",
        //sexto titulo del tema
    ...
    $contenido2 = [
        ...
        //3
        "<p>Los requisitos que debe cumplir un sistema de información y la complejidad de la información que se presenta en él provocan que el diseño de una base de datos sea un proceso complicado.</p>
<p> Para simplificar este proceso, es muy recomendable utilizar la estrategia de “divide y vencerás” (divide and conquer).</p>
<p>Si aplicamos este concepto, obtenemos las diferentes etapas del diseño de bases de datos. <p>Estas etapas son secuenciales y el resultado de cada una sirve de punto de partida de la etapa siguiente. El resultado de la última etapa será el diseño final de nuestra base de datos.</p>
<p> De este modo, un proceso de una cierta complejidad se descompone en diferentes procesos de menor complejidad. La figura 1 muestra las distintas etapas del diseño de bases de datos.</p>
<p>Hasta esta etapa del diseño de bases de datos todavía no ha sido necesario elegir el tipo de bases de datos que se utilizará (relacional, orientada a objetos, documental, etc.) ni el sistema gestor de bases de datos (SGBD (1) ) que se utilizará o el lenguaje concreto con el que se implementará la base de datos.</p>
<p>En el momento en el que se inicia la tercera etapa del proceso de diseño, el diseño lógico, hay que determinar el tipo de bases de datos que se utilizará. Es decir, no es necesario todavía escoger un SGBD concreto, pero sí el tipo de bases de datos que se quiere utilizar.</p>
<p> En esta etapa el esquema conceptual se convierte en un esquema lógico adecuado al tipo de bases de datos que se pretende usar.</p>
<p>Para determinar los requisitos, en primer lugar hay que establecer los actores del sistema de información que interaccionarán con la base de datos. Esto incluye a los usuarios y las aplicaciones, tanto si son nuevos como si no lo son.</p>
<p> Normalmente, un grupo de analistas se encarga de hacer el análisis de requisitos y, muy probablemente, este análisis suele ser informal, incompleto e incluso incoherente en algún punto. Por lo tanto, hay que dedicar muchos esfuerzos a trabajar esta información y convertirla en una especificación que los diseñadores de bases de datos puedan utilizar para modelizar e implementar el sistema de información.</p>
<h2>Ventajas del diseño de base de datos</h2>
<p>Un diseño de base de datos realizado de forma correcta nos proporciona una ventajas fundamentales:</p>

<p> •Nos permite ahorrar espacio, mediante el diseño de base de datos optimizadas y sin datos duplicados.</p>
 <p>•Nos ayuda a que se preserve la precisión e integridad de los datos y que no se pierda información.</p>
 <p>•Agiliza de forma extrema el acceso y el procesamiento de los datos.</p>
 <p>•Diseño de base de datos: fases principales</p>
 <p>•Como cada proceso, el diseño de base de datos está compuestos por distintas etapas secuenciales.</p>",

        //4
        "<h2>LOGICA DE ACCESO DE DATOS</h2>
<p>La capa de acceso a datos (DAL) creada en el primer tutorial separa limpiamente la lógica de acceso a datos de la lógica de presentación.</p>
<p> Sin embargo, aunque dal separa limpiamente los detalles de acceso a datos de la capa de presentación, no aplica ninguna regla de negocios que se pueda aplicar. Por ejemplo, CategoryID SupplierID Products Discontinued para nuestra aplicación, es posible que deseemos no permitir que se modifiquen los campos o de la tabla cuando el campo está establecido en 1, o es posible que deseemos aplicar reglas de antigüedad, lo que prohíbe situaciones en las que un empleado está administrado por alguien que fue contratado después de él. Otro escenario común es la autorización, quizás solo los usuarios de un rol determinado puedan eliminar productos o puedan cambiar el UnitPrice valor.</p>
<h2>LOGICA DE PRESENTACION DE DATOS</h2>
<h3>Descripción de capas lógicas</h3>
<p>Esta sección proporciona breves descripciones de las cuatro capas lógicas que se muestran en la Figura 2–4.</p>
<p>Las descripciones hacen referencia a los componentes de la aplicación implementados utilizando el modelo de componente de plataforma de J2EE.</p>
<p> No obstante, otros modelos de componente distribuidos, como CORBA, también son compatibles con esta arquitectura.</p>

<p>Capa de cliente. La capa de cliente está formada por la lógica de la aplicación a la que el usuario final accede directamente mediante una interfaz de usuario.</p>
<p>La lógica de la capa de cliente podría incluir clientes basados en navegadores, componentes de Java que se ejecuten en un equipo de escritorio o clientes móviles de JavaTM Platform, Micro Edition (plataforma J2METM) que se ejecuten en un dispositivo portátil.</p>

<p>Capa de presentación. La capa de presentación está formada por la lógica de aplicación, que prepara datos para su envío a la capa de cliente y procesa solicitudes desde la capa de cliente para su envío a la lógica de negocios del servidor.</p>
<p>La lógica en la capa de presentación está formada normalmente por componentes de J2EE como, por ejemplo, Java Servlet o los componentes de JSP que preparan los datos para enviarlos en formato HTML o XML, o que reciben solicitudes para procesarlas.</p>
<p>Esta capa también puede incluir un servicio de portal que proporcione acceso personalizado y seguro a los servicios de negocios en la capa de servicios de negocio.</p>

<p>Capa de servicios de negocios. La capa de servicios de negocio consiste en la lógica que realiza las funciones principales de la aplicación: procesamiento de datos, implementación de funciones de negocios, coordinación de varios usuarios y administración de recursos externos como, por ejemplo, bases de datos o sistemas heredados.</p>
<p> Esta capa suele estar formada por componentes firmemente acoplados que se ajustan al modelo de componentes distribuidos de J2EE como, por ejemplo, los objetos Java, los componentes EJB o los beans conducidos mediante mensajes.</p>
<p> Pueden montarse componentes de J2EE individuales para ofrecer servicios de negocios complejos, como, por ejemplo, un servicio de inventario o uno de cálculo de impuestos.</p>
<p> Los componentes individuales y los ensamblados de servicios se pueden encapsular como servicios web que no estén firmemente acoplados en un modelo de arquitectura orientada a servicios, que se ajuste a los estándares de la interfaz SOAP (Simple Object Access Protocol).</p> <p>Los servicios de negocios también se pueden crear como servidores independientes como, por ejemplo, un servidor de mensajería o un servidor de calendario empresarial.</p>

<p>Capa de datos. La capa de datos está formada por los servicios que proporcionan los datos persistentes utilizados por la lógica de negocios. Los datos pueden ser datos de aplicaciones almacenados en un sistema de administración de bases de datos o pueden incluir información de recursos y directorios almacenada en un almacén de datos de protocolo ligero de acceso a directorios (LDAP).</p>
<p> Los servicios de datos también pueden incluir alimentación de datos de orígenes externos o datos a los que se puede obtener acceso desde sistemas informáticos heredados.</p>",
...
•	Contiene reglas de gestión de eventos, del tipo SI Evento Z, entonces Acción W. Estas acciones pueden suponer peticiones al modelo o a las vistas. Una de estas peticiones a las vistas puede ser una llamada al método Actualizar(). Una petición al modelo puede ser Obtener_tiempo_de_entrega ( nueva_orden_de_venta ). </p>",
        ...
        //12
       " 1.	<p>El usuario interactúa con la interfaz de usuario de alguna forma (por ejemplo, el usuario pulsa un botón, enlace, etc.)
...
Para verificar que el ejemplo funcione correctamente es necesario verificar el resultado que nos da la consola, y como se muestra, el resultado es correcto.</p>",

        //14
        "<h2>Comunicación orientada a conexicion</h2>
<p>Un protocolo orientado a la conexión es un modo de comunicación de redes donde se debe establecer una conexión antes de transferir datos. Se identifica el flujo de tráfico con un identificador de conexión en lugar de utilizar explícitamente las direcciones de la fuente y el destino.
...
<h2>API</h2>
<p>Se trata de un conjunto de definiciones y protocolos que se utiliza para desarrollar e integrar el software de las aplicaciones, permitiendo la comunicación entre dos aplicaciones de software a través de un conjunto de reglas.
...
<p>Un socket (enchufe), es un método para la comunicación entre un programa del cliente y un programa del servidor en una red. Un socket se define como el punto final en una conexión. Los sockets se crean y se utilizan con un sistema de peticiones o de llamadas de función a veces llamados interfaz de programación de aplicación de sockets (API, application programming interface).</p>
<p>Un socket es también una dirección de Internet, combinando una dirección IP (la dirección numérica única de cuatro partes que identifica a un ordenador particular en Internet) y un número de puerto (el número que identifica una aplicación de Internet particular, como FTP, Gopher, o WWW).</p>",
        //17
        "<p>Los sockets en Java o cualquier otro lenguaje de programación sirven para interconectar dos sistemas a través de la red, sólo utilizando un número ip o nombre de host y un puerto determinado. La arquitectura utilizada en los sockets es la de Cliente/Servidor.
...
El servidor estará a la espera de una conexión, en cuanto el cliente inicie enviará un mensaje de petición al servidor, éste le responderá afirmativamente y una vez recibida la confirmación, el cliente enviará un par de mensajes y la conexión finalizará.</p>",
    ];
